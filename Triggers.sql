...
CREATE TRIGGER before_Hourly_pay_insert				-- before_Hourly_pay_insert :- this is just a name of trigger and dont have to do anything with the behaviour of the trigger
BEFORE INSERT ON Salary
FOR EACH ROW
SET NEW.YEARLY =(NEW.Hourly_Pay * 1920);

INSERT INTO Salary VALUES
(6, 'Jane', 'Smith', 18.75,NULL, 'Accountant', '2019-06-20');
